...
const calculatePredictionPoints = (prediction, actualStats) => {
  ...
  // Last Player Dismissed (optional bonus question)
  if (
    prediction.lastPlayerDismissed &&
    prediction.lastPlayerDismissed.answer !== undefined &&
    prediction.lastPlayerDismissed.answer !== '' &&
    prediction.lastPlayerDismissed.answer !== null &&
    actualStats.lastPlayerDismissed?.playerId
  ) {
